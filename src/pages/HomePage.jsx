...
function Calendar({ calendarData }) {
  ...
  const instructorColors = { Felix: 'bg-wu-blue', August: 'bg-emerald-400', Mars: 'bg-violet-500', Andy: 'bg-violet-500' }
  const instructorPanelColors = { Felix: 'bg-wu-blue/10', August: 'bg-emerald-400/10', Mars: 'bg-violet-500/10', Andy: 'bg-violet-500/10' }
